...
\begin{table*}[!htb]
  ...
  \begin{tabular}{l l p{7cm}}
    ...
    Mist Reaver Acolyte       & Trained to join the \nameref{sec:Mist Reavers} & Proficient with all martial weapons, light and medium armour, and shields. Favoured Enemy (Monstrous Races) \\
    Psyker                    & Member of the \nameref{sec:Helemic Order} & 4 bonus bonus power points at level 1, and two level 1 psion powers. \\
    Seer of Nyddwr            & Seer of \nameref{sec:Nyddwr}, female only & +2 wisdom, +4 bonus to sense motive, diplomacy and knowledge (old ways), telepathy 30 ft. \\
    ...
    Walburga Witch            & You are a \nameref{sec:Walburga} witch & +2 bonus to charisma, pick two level 1 soul powers \\
...
\begin{35efeat}{Mist Reaver Acolyte}
  \srditem{Description}{You trained as an acolyte of the \nameref{sec:Mist
      Reavers} but did not complete your training before turning towards a
    life of adventure. Perhaps you got cold feet before the initiation ritual
    that would have turned you into a vampire? Or perhaps, as a vampire, you
    thought your life better spent elsewhere.
  }
  \srditem{Requirements}{Any lawful alignment}
  \srditem{Benefits}{You gain proficiency with all martial weapons, light,
    and medium armours, as well as all shields, and immediately gain the feat
    \emph{Favoured Enemy (Monstrous Races)}, which includes all monstrous
    humanoid races, such as orcs, goblins, hobgoblins or gnolls.
  }
  \srditem{Drawbacks}{Monstrous races might become hostile if they learn of
    your background, and if you stray from your lawful alignment, you lose the
    benefits of the \emph{Favoured Enemy} feat.
  }
\end{35efeat}
...
\begin{35efeat}{Seer of Nyddwr}
  \srditem{Description}{You have trained for years to become one the three
  ...
  \srditem{Benefits}{You gain a +2 bonus to wisdom. You also gain a +4 bonus
    ...
    among with seers that trained with you.
  }
  \srdbackgroundfeat
\end{35efeat}
...
\begin{35efeat}{Walburga Witch}
  \srditem{Description}{You grew up among the witches of \nameref{sec:Walburga},
    your soul was successfully awoken during their initiation ritual.
  }
  \srditem{Requirements}{Follower and believer of \nameref{sec:Morana}, the lady
    of death and winter. You must be soul awoken. Please note that the DM might
    opt to not include soul magic within his campaign, in this case you were a
    handmaiden instead, and do not receive the extra soul powers. You must be
    a female of the core humanoid races, or a female of the half races.
  }
  \srditem{Benefits}{+2 to charisma, you may pick two additional level 1 soul
    powers if you are soul awoken. You may also cast \emph{Hide From Undead}
    three times a day, as a spell-like ability.
  }
  \srditem{Drawbacks}{You lose all these abilities if you abandon Morana, or if
    she abandons you. As a follower of Morana you may, or may not be popular
    among other religions, or tribes that worship the \nameref{sec:Old Ways}.
  }
  \srdbackgroundfeat
\end{35efeat}
