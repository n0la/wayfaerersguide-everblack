...
\begin{35efeat}{Adept of Aria}
  ...
  \srditem{Benefits}{You gain a +4 \emph{education} bonus to hide and move
    ...
    If you have cleric domains, you automatically gain the \emph{Trickery}
    domain}
  \srdeducationfeat
\end{35efeat}
...
\begin{35efeat}{Agent of the Well of Truth}
  ...
  \srditem{Benefits}{You gain a +4 \emph{education} bonus to open lock and
    ...
    If you have cleric domains, you automatically gain the \emph{Protection}
    domain.}
  \srdeducationfeat
\end{35efeat}
...
\begin{35efeat}{Follower of Forun}
  ...
  \srditem{Benefits}{You gain a +2 \emph{education} bonus to Charisma.
    ...
    (religion), and both skills become class skills for you. If you have
    cleric domains, you automatically gain the \emph{Fire} domain}
  \srdeducationfeat
\end{35efeat}
...
\begin{35efeat}{Citizen of Norbury}
  ...
  \srditem{Benefits}{You gain a +2 \emph{heritage} bonus to strength, and are
    ...
    hold Norbury citizenship in form of a
    \hyperref[sec:Citizen Papers]{citizen papers}.}
  \srdheritagefeat
\end{35efeat}
