...
\nameref{sec:Ramesk}, monstrous or fey blood - simply called ``crimson'' in
...
Civilised vampires can fall feral if they begin feasting on bile, and feral
...
Many of these old vampires turned from their creator and were then threatened
...
such as the \nameref{sec:Silent Queen}, who protected the wayward vampires
...
liquid food of the \nameref{sec:Ilians}, was discovered by a
\nameref{sec:Deepkin} expedition in the depths of the \nameref{sec:Cnamh
Mountains}. It took a few years of experimentation to adapt the liquid to work
...
Ramesk has a few other effects on vampires: It makes their nails and hair grow
...
\nameref{sec:Morana}. Feral vampires, are blind and hunt by scent only.
...
\begin{35e}{Vampire (Template)}
  ...
  \emph{Blood Drain} (Ex): A vampire can suck blood from a living victim
   ...
   points if the creature belongs to the monstrous races or is a fey. This
   natural attack is only available in grapple, and deals 1d8 non-lethal
   damage to a victim.  If the target is of the core humanoid races, the
   vampire takes 1 point of intelligence drain instead, and if the target is
   any other creature type (e.g. animal) the vampire gains no benefits.

  \emph{Energy Drain} (Ex): Living monstrous or fey creatures hit by a
   vampire's claw attacks (or any other natural weapon the vampire might
   possess), gain two negative levels. For each negative level bestowed, the
   vampire is healed for 1d8 hit points. A vampire can use its energy drain
  ...
  \srditem{Special Qualities}{A vampire retains all the special qualities of
    ...
    drain, except \nameref{sec:Ramesk}, or the blood of monstrous or fey
    creatures, at the rate of 1 point healed per day.
