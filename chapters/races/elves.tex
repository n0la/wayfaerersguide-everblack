...
\aren{There are some old racist jokes about elves: If you drown enough elves
  you will eventually produce an ``aquatic elf''.
}
...
\nameref{sec:Dirgewood}, while the second lives in the \nameref{sec:Toralian
  Highlands}. These wood elves live together with their brethren of the other
core races, and are commonly followers of the \nameref{sec:Old Ways}. They
...
The last tribe live in the jungles of \nameref{sec:Yuacata} and are often
