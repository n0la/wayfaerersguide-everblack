...
\aren{There are some old racist jokes about elves: If you burn enough elves
  you will eventually get a ``fire elf''.}

\graham{And if you drown enough elves you will eventually produce an ``aquatic
  elf''.}

\aren{We should stop now, lest we offend someone.}
