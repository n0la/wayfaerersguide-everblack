...
% Ancient Deepkin Clans
\input{chapters/organisations/deepkinclans}
% Church of Light
\input{chapters/organisations/churchoflight}
% Druidic Circles
\input{chapters/organisations/circles}
...
% Helemic Order
\input{chapters/organisations/helemicorder}
% Hunter's Guild
\input{chapters/organisations/huntersguild}
% Magistrata Arcanum
\input{chapters/organisations/magistrata}
% Mistreavers
\input{chapters/organisations/mistreavers}
% Nightwatch
\input{chapters/organisations/nightwatch}
% Scions of Silence
\input{chapters/organisations/scionsofsilence}
% Silver Hand
\input{chapters/organisations/silverhand}
% Knight Order of Tavos
\input{chapters/organisations/tavos}
% Ror-Aram Trading Corporation
\input{chapters/organisations/roraram}
% Two Courts
\input{chapters/organisations/twocourts}
% Velvet Hand
\input{chapters/organisations/velvethand}
% Walburga
\input{chapters/organisations/walburga}
% Wayfaerer's Guild
\input{chapters/organisations/wayfaerersguild}
% Well of Truth
\input{chapters/organisations/welloftruth}
