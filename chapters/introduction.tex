...
\nameref{sec:Graham Balance} an influential archmagi and bard, and
\nameref{sec:Aren Fel} the undying witch, a chronicler, follower of the
\nameref{sec:Silent Queen}, and a potent figure in the history of the
world.
...
The world of \nameref{sec:Aror} is old, and rich in history. Filled with
...
form of magic: \nameref{sec:Soul Magic}. While in \emph{Everblack} both arcane
...
But still the realm of Everblack is a place where adventurers set forth to
...
\begin{enumerate}
 ...
 \litem{Overall tone} \emph{Everblack} attempts to blend horror and low fantasy
 ...
 millennia old, and were ancient \nameref{sec:Daemons} meddle in the affairs
 of mortals. Powerful spells are rare, and magic is unreliable in the presence
 of \nameref{sec:Everblack}. At least \nameref{sec:Vampires} are your friends.

 \litem{Soul Magic} The setting introduces a new, fourth kind of magic to the
 world: \nameref{sec:Soul Magic}. It postulates that every living being has a
 ...
 \nameref{sec:Diarim} as well as the \nameref{sec:Umgeher} among
 ...
 dissolved within the \nameref{sec:Soul Well}, and will ask a steep price for
 doing so.

 \litem{Island among the planes} A huge, and ancient device called the
 \nameref{sec:Monolith} isolates Aror from the planescape, and makes inter
 planar magic difficult, and dangerous.

 \litem{Intelligence gives choice} Any creature that is intelligent may chose
 its own alignment. This also applies to the classically ``evil'' creatures
 such as monstrous races, undead, and even devils.

 \litem{Culture above race} There are no racial states or nations on Aror, as
...
The following book should serve you well as an introduction to the place you
...
\nameref{sec:Muut} in the south; the lone yet towering \nameref{sec:Goban}
mountain in the east; the endless treasures, archipelagos and beaches that the
\nameref{sec:Silver Isles} have to offer; or the vast mountains, lush forests,
and friendly locals of \nameref{sec:Eilean Mor}. If that does not impress you,
I am sure the grandious library and arcane college of \nameref{sec:Fes
  al-Bashir}, the towering cliff side castle of \nameref{sec:Forsby} or the
endless riches in art and music of \nameref{sec:Nen-Hilith} surely will make a
lasting impression.
