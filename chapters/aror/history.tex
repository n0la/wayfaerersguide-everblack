...
\begin{longtable}{@{\,}r <{\hskip 6pt} !{
  ...
  >{\raggedright\arraybackslash}p{11cm}
    ...
    ca. GT:-2.200    & Armistice between monstrous and humanoid races, and the
                       ...
                       the ever growing threat from the fey. \\
    ...
    GT:-390          & Eigyr conquers many major monstrous cities, razing them,
                       and establishing her empire. This year marks the end of
                       the strife on \nameref{sec:Eilean Mor}. \\
    GT:0             & \nameref{sec:Fes al-Bashir} officially declares itself a
                       kingdom, marking the beginning of the age of the city
                       kingdoms. \\
    ...
    GT:592           & \nameref{sec:Esmayar} is recognised as a city state. \\
    GT:755           & The devils invade Aror. \\
    ...
    GT:1082          & \nameref{sec:Second Crusade} into the heart of the
                       layers of hell begins, and succeeds in rescuing the
                       \nameref{sec:Triumvirate}. \\
    ...
    MI:1680          & A \nameref{sec:Plague} almost wipes out Hraglund, followed
                       by devastating wars against the weakened city kingdom two
                       years later. \\
...
wounded pride with them. The \nameref{sec:Beast Wars}, or the sacking of
\nameref{sec:Esmayar}, or \nameref{sec:Nen-Hilith} are more recent conflicts,
...
targeted mostly centres of arcane scholarship, such as the \nameref{sec:Hall
  of Knowledge} in Fes al-Bashir, as well as the \nameref{sec:Magistrata
  Arcanum} in Forsby. Secondary attacks targeted large population centres, in
an attempt to distract major military forces and splitting their attention
among several smaller incursions and invasions.

The \nameref{sec:Aurelis} of Celestis, including Lor himself, aided in the
