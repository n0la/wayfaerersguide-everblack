...
%% Dirgewood
\input{chapters/aror/regions/dirgewood}

%% Farou Island
\input{chapters/aror/regions/farouisland}

%% Kanaria Archipelago
\input{chapters/aror/regions/kanaria}

%% Pale
\input{chapters/aror/regions/pale}

%% Great Divide, The
\input{chapters/aror/regions/greatdivide}

%% Isles of Conflagration, The
\input{chapters/aror/regions/islesofconflagration}

%% Silver Isles
\input{chapters/aror/regions/silverisles}

%% Suam Desert
\input{chapters/aror/regions/suamdesert}

%% Toralian Highlands
\input{chapters/aror/regions/toralianhighlands}

%% Walusian Desert
\input{chapters/aror/regions/walusiandesert}

%% Yua'cata
\input{chapters/aror/regions/yuacata}
