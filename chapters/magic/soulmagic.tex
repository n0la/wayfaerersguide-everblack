...
much like the body replenishes itself after a few hours from physical
exhaustion. People that are aware of their own souls can draw that power,
direct it, and put it to work. How much soul power that is available is
directly related to the strength of the person itself. The soul is only as
powerful as the combined trinity of soul, body and personality.
...
character strength, intellect and presence and self confidence. Those ill,
sick, broken in spirit and wounded mentally find it harder to conjure and
tap into their own souls.
...
\begin{35e}{Soul Power}
  ...
  \emph{soul power points}. Once awoken each creature gains \emph{soul power
    hit die} soul power points, and for every new level he or she gains after
  being awoken. Charisma increases the soul power pool, and functions similar
  as to how constitution works in regards to the HP pool.

  The soul power hit die is at first equal to the classes hit die, but there
  are several factors that may increase or decrease the soul power hit dice
  steps. The steps are: 1, d2, d4, d6, d8, d10, d12.
  ...
  A fifth level fighter with 10 charisma would gain 1d10+0 (one step up due to
...
\begin{table*}[!htb]
  ...
  \begin{tabular}{p{7cm} l}
    \textbf{Condition} & \textbf{Step deviation from d8} \\
    Arcane wielder     & -1 step \\
    Divine Wielder     & -1 step \\
    One strong save    & -1 step \\
    Two strong saves   & +1 step \\
    Three strong saves & +2 steps \\
    Half BAB           & -1 steps \\
