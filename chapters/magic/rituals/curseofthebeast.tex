...
\begin{35e}{Primal Curse}
  ...
  \srditem{Failure}{%
    All druids are forced into a \emph{chaotic evil} animal shape for 2d4
    hours, corresponding to the animal of the intended were creature. They
    cannot determine friend from foe, and will thus attack each other.
  }
  ...
  \srditem{Description}{%
    ...
    intended were creature for 2d4 hours. They cannot determine friend from
    foe, and will thus attack each other.
  }
\end{35e}
