...
\incgraph[
  overlay={\node[black] at ([xshift=0cm,yshift=-1cm] page.north)
    (main)[text width=0.9\paperwidth]{
      \large \centering
      \textbf{``Two halfling priestesses of Forun preach to theirfollowers
        during the Day of Candles.''}
    };
    \node[black, below=of main,yshift=1cm]{
      \nameref{sec:Helmarnock} circa GT:16108
    };
  }
]{media/forun-dayofcandles.png}
\clearpage
