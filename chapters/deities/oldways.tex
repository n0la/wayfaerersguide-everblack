...
was held by \nameref{sec:Morana}. The texts describe her as one who stood for
...
mother, which has lead \nameref{sec:Graham Balance} to propose a new mother
\nameref{sec:Sea Priestess}. The Sea Priestess's acceptance, as well as
...
\aren{If you wish to keep the peace at a village gathering in the
  \nameref{sec:Toralian Highlands} better not bring up the fourth mother.}
...
\subsubsection{Gweneth}
\label{sec:Gweneth}

The most important set of stories in the \nameref{sec:Old Ways}, are those
...
others she met \nameref{sec:Frau Perchta}, who brought her back to righteous
path.
