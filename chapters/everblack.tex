...
the \nameref{sec:Cnámh Mountains} for everblack, and then sell most of it to
...
By crushing the crystal and mixing it with water, one can make everblack ink,
...
Small chips of everblack, roughly a centimetre in diameter - also referred to
as \emph{shins} - are a common currency accepted everywhere on the world of
\nameref{sec:Aror}. These are often useless for magical applications due to
their small size, but still hold value as a currency. They are roughly
equivalent to one copper coin and are used to make everyday purchases.
...
property and artefacts. Shards are roughly equivalent to one coin of platinum.
