...
are listed as separate species, they are very close to one another. Even
though more variety exists by the elves they are still so close to one another
that they are capable of creating viable and healthy offspring among each
other.

The core races generally have good relations with one another, and also live
happily together in large city kingdoms. The only exception being a few secluded,
...
core humanoid races, and the child of an orc and any of the core humanoid
races is called a half-orcs. Medusa must rely on humanoids to produce, and
...
The most well known daemon is \nameref{sec:Morana}, and her creations the
\nameref{sec:Calean Wraiths}.
