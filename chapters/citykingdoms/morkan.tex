...
\begin{infobox}{City Kingdom of Morkan}
  ...
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.20\linewidth]{media/morkan-banner.\imagesuffix}
  \end{subfigure}
  \vspace{-1.0cm}
  \fi
  \begin{multicols}{2}
...
The ogres and orcs laid siege the small kingdom of Morkan for several
