...
\begin{figure*}[ht!]
  ...
  \centerline{
    \includegraphics[width=\paperwidth,keepaspectratio]{%
      media/tredegar.\imagesuffix
    }
  }
\end{figure*}
\fi

\begin{infobox}{City Kingdom of Tredegår}
  \ifimages
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.22\linewidth]{%
      media/tredegar-banner.\imagesuffix
    }
  \end{subfigure}%
  \fi%
  \begin{multicols}{2}
    \begin{itemize}[label={},noitemsep,leftmargin=0.0cm,topsep=0pt]
      ...
      \infoboxitem{Languages}{Teranim, Old-High Teranim}
      \infoboxitem{Government}{Absolute Monarchy}
      \infoboxitem{Major Religions}{\nameref{sec:Forun}, atheism}
      \infoboxitem{Area}{est. 440,000 $km^2$}
      \infoboxitem{Population}{est. 32 million people}
      \infoboxitem{Non Grata}{none}
      \infoboxitem{Magic}{Any magic given proper permit is allowed}
      \infoboxitem{Slavery}{outlawed, imprisons criminals}
      \infoboxitem{Special Laws}{grants asylum to run-away slaves given
        they are not criminals
      }
      \infoboxitem{Notable Organisations}{head quarters of
        \nameref{sec:House Ranian}, Steel and Gold Corporation
      }
      \infoboxitem{POI}{An'Rath a massive palace and castle complex at
        the centre of the city, university of applied arcane sciences,
        central park, as well as many recreational beaches, grand temple
        to \nameref{sec:Forun}, oldest known tavern of Aror called
        ``Drunken Trader''
      }
    \end{itemize}
  \end{multicols}
