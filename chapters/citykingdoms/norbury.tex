...
\begin{infobox}{City Kingdom of Norbury}
  \begin{subfigure}[t]{\textwidth}
    \centering
    \captionsetup{position=bottom,labelformat=empty}
    \subcaption{Coat of Arms}
    \includegraphics[width=0.15\linewidth]{media/norbury-bannersm.png}
  \end{subfigure}
  \begin{multicols}{2}
    \begin{itemize}[label={},noitemsep,leftmargin=0.1cm]
      ...
      \infoboxitem{Non Grata}{free monstrous races, devils (including
        tieflings), priests and knights of \nameref{sec:Lor}
      }
