...
\begin{35efeats}{Norbury Feats}
  \begin{35efeat}{Norbury Slave}
    \srditem{Description}{You were enslaved by the Hunter's Guild and spent
      much of your life in enslavement in Norbury, doing heavy labour or even
      fought in the slave regiments of the city.}
    \srditem{Requirements}{grew up enslaved in Norbury}
    \srditem{Benefits}{You gain +2 \emph{heritage} bonus to constitution.}
  \end{35efeat}
  \begin{35efeat}{Citizen of Norbury}
    \srditem{Description}{You grew up as a citizen of Norbury, and stayed there
      for most of your early live. You completed the mandatory civil service and
      now hold a basic citizenship of Norbury.}
    \srditem{Requirements}{grew up free in Norbury}
    \srditem{Benefits}{You gain a +2 \emph{heritage} bonus to strength, and are
      proficient with \emph{all composite bows} as well as \emph{bastard swords}
      and \emph{scimitars}.}
  \end{35efeat}
\end{35efeats}
