...
\begin{35e}{Snow Elf Bow}
  ...
  \srditem{Cost}{Snow elf craft template adds 2000 GP (200 shards) to the other
    costs associated with creating a given weapon.
  }
  \srditem{Affinities}{Flaming (for Forun aligned) or Cold (for Isamir aligned).
  }
  \srditem{Special}{Forun aligned snow elf bows allow the user to fully utilize
    their strength bonuses when making ranged attacks, while an Isamir aligned
    snow elf bow allows the user to apply their dexterity modifier to damage
    with the bow.
  }
\end{35e}
